...
export const MoonOrSun = styled.div<{
  ...
  &::after {
    border-radius: 50%;
    box-shadow: 0 -23px 0 #ffdf37, 0 23px 0 #ffdf37, 23px 0 0 #ffdf37, -23px 0 0 #ffdf37,
      15px 15px 0 #ffdf37, -15px 15px 0 #ffdf37, 15px -15px 0 #ffdf37, -15px -15px 0 #ffdf37;
    content: '';
    height: 8px;
    left: 50%;
    margin: -4px 0 0 -4px;
...
export const MoonMask = styled.div<{
  ...
  background: ${({ theme }) => theme.colors.cssVar(theme.colors.variables.body)};
  border-radius: 50%;
  border: 0;
  height: 24px;
  opacity: ${(p) => (p.isDark ? 0 : 1)};
